...
local menu = "/home/zaki/.local/bin/dashboard-launcher"
...
-- Laptop multimedia keys for volume and LCD brightness (With 200% Volume Booster)
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("/home/zaki/.local/bin/volume-booster +5"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("/home/zaki/.local/bin/volume-booster -5"), { locked = true, repeating = true })
hl.bind("XF86AudioMute",        hl.dsp.exec_cmd("/home/zaki/.local/bin/volume-booster mute"), { locked = true, repeating = true })
...
-- Screenshot Binds (PrtSc) - Includes Mouse Pointer (-c)
hl.bind("Print", hl.dsp.exec_cmd("/home/zaki/.local/bin/take-screenshot region"))
hl.bind("SHIFT + Print", hl.dsp.exec_cmd("/home/zaki/.local/bin/take-screenshot output"))
hl.bind("CTRL + Print", hl.dsp.exec_cmd("/home/zaki/.local/bin/take-screenshot window"))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("/home/zaki/.local/bin/take-screenshot region"))
...
hl.window_rule({
    name  = "sys-menu-floating",
    match = { class = "floating_sys" },
...
hl.window_rule({
    name  = "dashboard-launcher-floating",
    match = { class = "custom_launcher" },
...
hl.window_rule({
    ...
    match = { title = ".*(Save|Open|Select|Chooser|File Upload).*" },
...
hl.window_rule({
    name  = "wallpaper-picker-floating",
    match = { class = "wallpaper_picker" },
